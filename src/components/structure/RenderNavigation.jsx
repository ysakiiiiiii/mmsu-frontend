...
export const RenderMenu = () => {
  ...
  return (
    <nav className="flex justify-center bg-white py-2 mx-6 mfont mt-4 mb-3">
      <div className="w-full max-w-full h-10 mx-1 px-4 grid grid-cols-[1.5fr_2fr_1.5fr] items-center">
        {/* Logo Section */}
